...
function openDemo() {
	demoWND = window.open ('LRLdemo1.html', 'LRLdemo', 'top=200,left=0,scrollbars=no,status=no,toolbar=no,menubar=no,width=700,height=600')	
	if (!demoWND) {console.log ('no demoWND')}
//	demoDIV = demoWND.demoDIV
}
	
function openTools() {
	toolsWND = window.open ('LRLtools.html', 'LRLtools', 'top=200,left=850,scrollbars=no,status=no,toolbar=no,menubar=no,width=700,height=600')
	if (!toolsWND) {console.log ('no toolsWND')}
//	toolsDIV = toolsWND.toolsDIV
}	
