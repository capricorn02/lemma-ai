...
function initPlayerEvents() {
	const bP = document.querySelector('#w2ui-popup #btn-player-play');
	const bS = document.querySelector('#w2ui-popup #btn-player-pause');
	const bC = document.querySelector('#w2ui-popup #btn-player-close');
	bP.onclick = () => AppState.activeSlideInstance.play();
	bS.onclick = () => AppState.activeSlideInstance.pause();
	bC.onclick = () => w2popup.close();
}
